...
// months.splice(4, 1, "TEST"); // 교체
months.splice(4, 0, "TEST"); // 삽입
console.log(months);
...
const mix1 = idol1.concat(idol2, idol3); // 원본 보존
console.log(mix1);
console.log(idol1);

const extract = mix1.slice(1, 4); // 원본 보존
console.log(extract);
console.log(mix1);

// const reverse = mix1.reverse(); // 원본도 변경됨
// console.log(reverse);
// console.log(mix1);

console.log([...mix1].reverse()); // 원본 변경 없이 역순 출력
console.log(mix1);
...
for (let item of seasons.entries()) {
  console.log(item);
}
