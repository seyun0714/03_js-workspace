...
parameterTest("dfaafsd");
parameterTest(12345);
parameterTest(1, 2, 3, 4, 5); // 더 많은 인자 전달 시 초과되는 값은 무시
parameterTest(); // 더 적은 인자 전달 시 매개변수에는 초기화되지 않음(undefined)
