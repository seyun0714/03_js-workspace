...
var userId;
console.log(userId); // 특징1. 할당 전 - undefined (초기화 없이 선언 가능)
 ...
 * 4. 보완되어서 ES6부터 도입된게 let, const (권장)
 */

// 2. let
let userName;
console.log(userName); // 특징1. 할당 전 - undefined (초기화 없이 선언 가능)
// let userName; // 특징2. 재선언 - 불가능 (동일 스코프에 중복 선언 불가능)

userName = "박세윤";
userName = "백세윤"; // 특징3. 재할당 - 가능
...
function letScopeTest() {
  ...
  //console.log(userAge) // 특징4. scope - 블록 스코프
}
letScopeTest();

// 3. const - 상수(변경이 불가능한 값)를 선언하기 위해 사용되는 키워드

// const userHobby; // 특징1. 할당 전 - 사용 불가능 (초기화를 해야 사용 가능)
const userHobby = "게임";
//const userHobby = "요리"; // 특징2. 재선언 - 불가능
